    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Администратор'), ('moderator', 'Модератор'), ('user', 'Пользователь')], default='user', max_length=20, verbose_name='Уровень доступа')),
                ('bio', models.TextField(blank=True, null=True, verbose_name='Информация по пользователе')),
